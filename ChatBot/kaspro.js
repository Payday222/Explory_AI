...
io.on('connection', (socket) => {
  ...
  socket.on('evaluateAnswer', (data) => {
    const {answer } = data;
    let prompt = `Take the role of a teacher. For the test generated by you earlier a student submitted the following answers ${JSON.stringify(data)}, evaluate them. provide the score, and some feedback`
    const evaluationResult = getChatCompletion(prompt, socket);
  })
});
